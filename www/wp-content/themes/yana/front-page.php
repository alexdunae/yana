...
<section class="home-circles">
  <div class="content">
    <div class="entry entry-0">
      <div class="inner">
        <h2 class="title"><a href="#todo">Get Support for your Family</a></h2>
    ...
    <div class="entry entry-1">
      <div class="inner">
        <h2 class="title"><a href="#todo">Organize a Fundraiser</a></h2>
    ...
    <div class="entry entry-2">
      <div class="inner">
        <h2 class="title"><a href="#todo">Volunteer with us</a></h2>
    ...
    <div class="entry entry-3">
      <div class="inner">
        <h2 class="title"><a href="#todo">Donate to YANA</a></h2>
